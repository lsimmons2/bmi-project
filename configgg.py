...
# AGE_TRAINED_WEIGHTS_FILE = '/content/drive/My Drive/age_only_resnet50_weights.061-3.300-4.410.hdf5'
# CROPPED_IMGS_DIR = '/content/drive/My Drive/Normalized_Images'
